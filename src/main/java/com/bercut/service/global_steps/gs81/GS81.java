...
import com.bercut.service.utils.Helper;
...
//    }
    ...
    public GS81Response execute() {
        GS81Response response = new GS81Response();
        ...
        if (runNextStep) {
            //step 5
            if (Helper.optionalParameterCheck(inputs.getNesovmestimyeUslugiGet())) {
                response.setIncompatibleServIdList(getIncompatibleServIdList());
            }

            //step 6
            if (Helper.optionalParameterCheck(inputs.getVkljuchenaVtarifnyjPlanGet())) {
                response.setVkljuchenaVtarifnyjPlanFlag(getVkljuchenaVtarifnyjPlanFlag());
            }

            //step 7
            if (Helper.optionalParameterCheck(inputs.getVozmozhnostPokazyvatVpodkljuchennykhGet())) {
                response.setVozmozhnostPokazyvatVpodkljuchennykhFlag(getVozmozhnostPokazyvatVpodkljuchennykhFlag());
            }

            //step 8
            if (Helper.optionalParameterCheck(inputs.getVidimostVdostupnykhGet())) {
            ...
            //step 12
            if (Helper.optionalParameterCheck(inputs.getUslugaPersolanlizaciiGet())) {
                response.setUslugaPersonalizaciiFlag(getUslugaPersonalizaciiFlag());
            }

            //step 13
            if (Helper.optionalParameterCheck(inputs.getVozmozhnostPodkljuchenijaGet())) {
                response.setVozmozhnostPodkljuchenijaFlag(getVozmozhnostPodkljuchenijaFlag());
            }

            //step 14
            if (Helper.optionalParameterCheck(inputs.getVozmozhnostOtkljuchenijaGet())) {
                response.setVozmozhnostOtkljuchenijaFlag(getVozmozhnostOtkljuchenijaFlag());
            }

            //step 15
            if (Helper.optionalParameterCheck(inputs.getNazvanieUslugiGet())) {
